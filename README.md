...
# Smart Recipes
[![GitHub tag](https://img.shields.io/github/tag/Kir-Antipov/smart-recipes.svg?cacheSeconds=3600)](https://github.com/Kir-Antipov/smart-recipes/releases/latest)
...
```properties
smartrecipes_version=0.1.0+1.17
```

Sadly, GitHub Packages are far from ideal, so you will need a GitHub token in order to download a **public** package...
